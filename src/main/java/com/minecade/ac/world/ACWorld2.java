...
public class ACWorld2 extends ACBaseWorld {

    /**
     * ACWorld2 constructor
     * @param plugin
     * @author Kvnamo
     */
    public ACWorld2(MinecadePlugin plugin) {
...
//        addNpcLocation(NPCEnum.GREEN, new MapLocation(-153, 123, -75.44));
//        addNpcLocation(NPCEnum.GRAY, new MapLocation(-154.41, 117, -43.40));
//        addNpcLocation(NPCEnum.RED, new MapLocation(-178.65, 117, -48.36));
//        addNpcLocation(NPCEnum.WHITE, new MapLocation(-212, 116, -37));
    }
}
